...
public class Regex {
    ...
    public static void note() {
        ...
        String regex = "(\\d|(1\\d))(,\\d)?|20(,0)?";
        
        // jeux de tests
        String[] chaineCorrecte = { "20", "12", "15,6", "9,9", "0", "20,0", "5,0"};
        String[] chaineIncorrecte = { "05","20,1","31","10,50"};
    ...
    public static void numeroRue() {
         ...
         */
        String regex  = "[1-9](\\d?){2}( Ter| TER| ter| Bis| bis| BIS)?";
    ...
    public static void horaire() {
         ...
         * suivi d'un chiffre
         */
    	String regex  = "([01]\\d|2[0-3])"
    			//TODO trouver pour H on-case sensitive
    			+ "[hH][0-5]\\d";
        
        // jeux de tests
        String[] chaineCorrecte = { "09h10", "01H05", "23h59", "11h11", "20h00",
                                    "21H48", "22h31", "23h28"};
        String[] chaineIncorrecte = { "9h10", "451H20", "23h77","023h45"};
    ...
    public static void paquetageJava() {
         ...
         * puis éventuellement, 1 ou plusieurs fois, un point et le motif précédent
         */
    ...
    public static void prenom() {
         ...
         * éventuellement ensuite : tiret, une majusucle, suivie de au moins une minuscule
         */
        String regex = "[A-Z][a-z]+(-[A-Z][a-z]+)?";
        
        // jeux de tests
        String[] chaineCorrecte = { "Marie-Helene", "Marie", "Jean-Michel","Jean-Ba"};
    ...
    public static void commande() {
         ...
         */
        String regex = "\\s*([?Qq]|([VvDdSs]\\s+\\d)|([cCeE]\\s+\\d\\s+\\d+))\\s*";
                       // ou  "\\s*[Ee]\\s+\\d\\s+\\d+\\s*"
